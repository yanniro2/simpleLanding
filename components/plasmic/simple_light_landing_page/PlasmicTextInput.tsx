...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 6_iGZM3DCKSD/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__xvwW9)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__zHBwY)}
              role={"img"}
            />
          ),
